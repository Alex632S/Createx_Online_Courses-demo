<div class="header-row"> 
   <ul class="header-nav">
      ...
      <li> <a class="header-nav__link" href="contacts.php"><span class="header-nav__title">Contacts</span></a></li>
   </ul>
   <ul class="header-cta"> 
      <li>
      ...
      <li>
         <div class="login">
            <div class="login__icon">
               <img src="./img/navbar/Profile.svg" alt="login icon">
            </div>
            <a class="login__link" href="#">
               <span class="login__title">Log in</span>
            </a>
            <span class="login__slash">&nbsp;/&nbsp;</span>
            <a class="login__link" href="#"> 
               <span class="login__title">Register</span>
            </a>
         </div>
      </li>
   </ul>
