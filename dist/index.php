      ...
      <div class="container container-flex header-middle-margin">
        <div class="container-column cc-size">
          ...
          <ul class="cc-wrap cc-wrap-flex">
            ...
            <li> 
              <button class="button-global"> <span class="button-global__title">Explore courses</span></button>
            </li>
          </ul>
        </div>
      ...
      <div class="container">
        <div class="container-column">
          <div class="section-02-header footer-top-column__link">
            ...
            <button class="button-global-opacity"><span class="button-global-opacity__title">View all courses</span></button>
          </div>
      ...
      <div class="container"> 
        <div class="container-column container-column-center">
          ...
          <ul class="list-categorys">
            ...
            <li>
              <button class="list-categorys__btn"> <span class="list-categorys__description list-categorys__community"> Community</span></button>
            </li>
          </ul>
          <div class="section-03-bottom container-flex">
            ...
            <div class="container-image"> <img class="container-image__img" src="./img/section-03/learn.svg" alt="people learn"></div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="container-column">
          ...
          <ul class="section-04-row">
            ...
            <li> 
              <button class="button-global"> <span class="button-global__title">Explore all events</span></button>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section class="blog">
      <div class="container">
        <div class="section-02-header footer-top-column__link">
          ...
          <button class="button-global"><span class="button-global__title">Go to blog</span></button>
        </div>
